...
public class PlaybackControlView extends FrameLayout {
    ...
    private static final class DefaultControlDispatcher
            extends com.google.android.exoplayer2.DefaultControlDispatcher implements com.google.android.exoplayer2.ui.PlaybackControlView.ControlDispatcher {}
    /**
    ...
    public static boolean downloadButtonShow = false;
    ...
    public PlaybackControlView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, attrs,null);
    }

    public PlaybackControlView(Context context, AttributeSet attrs, int defStyleAttr,
                               AttributeSet playbackAttrs,DownLoadClickListener downLoadClickListener) {
        super(context, attrs, defStyleAttr);
        int controllerLayoutId = R.layout.player_playback_control_view;
        ...
        setOnDownLoadClickListener(downLoadClickListener);
        ...
        if(downloadButtonShow){
            ...
            if (downloadButton != null) {
                downloadButton.setOnClickListener(componentListener);
            }
        }
    ...
    /**
     * Sets the {@link com.google.android.exoplayer2.ui.PlaybackControlView.VisibilityListener}.
     *
    ...
    private final class ComponentListener extends Player.DefaultEventListener implements
            TimeBar.OnScrubListener, View.OnClickListener {
