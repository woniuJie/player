...
/* package */ final class TrackSelectionHelper implements View.OnClickListener,
  ...
  private View buildView(Context context) {
    ...
    disableView.setText(R.string.player_selection_disabled);
    ...
    defaultView.setText(R.string.player_selection_default);
    ...
    for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
      ...
      for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
        ...
        trackView.setText(PlayUtil.buildTrackName(group.getFormat(trackIndex)));
    ...
    if (haveAdaptiveTracks) {
      ...
      enableRandomAdaptationView.setText(R.string.player_enable_random_adaptation);
