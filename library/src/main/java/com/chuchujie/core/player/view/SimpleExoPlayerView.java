...
public final class SimpleExoPlayerView extends FrameLayout {
    ...
    public PlaybackControlView.DownLoadClickListener downLoadClickListener;
    public SimpleExoPlayerView(Context context, PlaybackControlView.DownLoadClickListener downLoadClickListener) {

        this(context, null,downLoadClickListener);
    }


    public SimpleExoPlayerView(Context context, AttributeSet attrs, PlaybackControlView.DownLoadClickListener downLoadClickListener) {
        this(context, attrs, 0,downLoadClickListener);
    }

    public SimpleExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr, PlaybackControlView.DownLoadClickListener downLoadClickListener) {
        ...
        if (customController != null) {
            ...
            this.controller = new PlaybackControlView(context, null, 0, attrs,downLoadClickListener);
    ...
    public void setDownLoadClickListener(PlaybackControlView.DownLoadClickListener downLoadClickListener){
